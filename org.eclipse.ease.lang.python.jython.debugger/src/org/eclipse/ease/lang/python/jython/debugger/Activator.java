...
import org.eclipse.ease.lang.python.jython.JythonPackageManager;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.ease.lang.python.jython.debugger"; //$NON-NLS-1$
	...
	public void start(final BundleContext context) throws Exception {
		...
		// FIXME for now caching is disabled. We need to track how the cache
		// destination is calculated
		PySystemState.packageManager = new JythonPackageManager(null,
